...
<body class="flex flex-col min-h-screen">
  ...
  <div   class="lg:m-10 m-4 bg-white flex-grow">
    ...
    <form class="py-8 border rounded-b-lg" action="./controller/update_kategori.php" method="POST">
      <div class="sm:max-w-sm sm:mx-auto mx-4">
        ...
        <div class="mb-5">
          ...
          <input type="text" id="base-input" value="<?php echo $ambil_data['nama_kategori']; ?>" placeholder="Nama Kategori" name="nama_kategori" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
        </div>
        <?php 
          }
        ?>
