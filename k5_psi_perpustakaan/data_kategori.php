...
<body class="flex flex-col min-h-screen">
  ...
  <div class="lg:m-10 m-4 bg-white">
    ...
    <div class="lg:p-6 p-4 flex justify-between rounded-0 border md:flex-row flex-col gap-4">
      ...
      <a href="tambah_kategori.php" class="flex text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-3 items-center gap-2">
      ...
      <form method="GET">
        <div class="flex">
          <div class="relative h-full flex">
            <input type="search" id="search-dropdown" name="keyword" class="w-full bg-gray-50 rounded-s-lg border border-gray-300" placeholder="Cari kategori">
    ...
    <div class="relative overflow-x-auto border sm:rounded-b-lg flex-grow">
