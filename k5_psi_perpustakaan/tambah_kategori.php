...
<body class="flex flex-col min-h-screen">
  ...
  <div class="lg:m-10 m-4 bg-white flex-grow">
    <a class="flex px-6 py-3 border rounded-lg mb-4 w-fit bg-gray-100" href="./data_kategori.php">
    ...
    <form class="py-8 border rounded-b-lg" action="./controller/save_kategori.php" method="POST">
